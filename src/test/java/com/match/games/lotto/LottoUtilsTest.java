...
public class LottoUtilsTest {
    ...
    public void generateReturnsResult() {
        LottoResult result = LottoUtils.generate(12);
    ...
    public void generateRetrunsResultWithinRange() {
        int max = 42;
        LottoResult result = LottoUtils.generate(max);
    ...
    public void generateReturnsNoDuplicates() {
        LottoResult result = LottoUtils.generate(7);
    ...
    public void evaluateMatch6Wins() {
        ...
        Optional<WinType> owt = LottoUtils.evaluate(selection, lr);
